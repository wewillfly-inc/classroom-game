...
const I18n = (() => {
    ...
    const strings = {
        it: {
            ...
            instrMobile1: 'Tocca una bandiera per scegliere la lingua',
            instrMobile2: 'Tocca un alunno EVIDENZIATO per passare il bigliettino',
            instrMobile3: 'dal secchione (★) al somaro (😢)',
            instrMobile4: 'Attento! Non passare quando la maestra guarda!',
            instrMobile5: 'Impostazioni: tocca le opzioni, poi GIOCA!',
            nextButton: 'AVANTI',
            titleLangHintDesktop: '\u2190 \u2192 per cambiare lingua',
            titleLangHintMobile: 'Tocca una bandiera',
        ...
        en: {
            ...
            instrMobile1: 'Tap a flag to choose your language',
            instrMobile2: 'Tap a HIGHLIGHTED student to pass the note',
            instrMobile3: 'from the nerd (★) to the dunce (😢)',
            instrMobile4: 'Watch out! Don\'t pass when the teacher is watching!',
            instrMobile5: 'Settings: tap options, then PLAY!',
            nextButton: 'NEXT',
            titleLangHintDesktop: '\u2190 \u2192 to change language',
            titleLangHintMobile: 'Tap a flag',
        ...
        de: {
            ...
            instrMobile1: 'Tippe auf eine Flagge für die Sprache',
            instrMobile2: 'Tippe auf einen MARKIERTEN Schüler zum Weitergeben',
            instrMobile3: 'vom Streber (★) zum Taugenichts (😢)',
            instrMobile4: 'Vorsicht! Nicht weitergeben wenn die Lehrerin schaut!',
            instrMobile5: 'Einstellungen: Optionen tippen, dann SPIELEN!',
            nextButton: 'WEITER',
            titleLangHintDesktop: '\u2190 \u2192 Sprache wechseln',
            titleLangHintMobile: 'Tippe auf eine Flagge',
